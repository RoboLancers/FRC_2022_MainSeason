...
public class ShootOneBallAlt extends SequentialCommandGroup {
    public ShootOneBallAlt (Drivetrain drivetrain, Turret turret, Indexer indexer) {
        ...
        addCommands(
            ...
            new ParallelRaceGroup(new UpperHubShot(turret), new SequentialCommandGroup(new WaitCommand(1.0),
