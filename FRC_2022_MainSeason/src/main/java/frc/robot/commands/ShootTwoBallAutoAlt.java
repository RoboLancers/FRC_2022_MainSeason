...
public class ShootTwoBallAutoAlt extends SequentialCommandGroup {
    public ShootTwoBallAutoAlt (Drivetrain drivetrain, Turret turret, Indexer indexer, Intake intake) {
        ...
        addCommands(
            ...
            new ParallelRaceGroup(new UpperHubShoot(turret), new SequentialCommandGroup(new WaitCommand(1.5),
         ...
         new ParallelRaceGroup( new RunCommand(()-> drivetrain.curvatureDrive(0.4, 0)), new WaitCommand(2)),
        new InstantCommand(()-> drivetrain.curvatureDrive(0.4, 0.0)),
 
        //new UseIntake(intake),
 
        new ParallelRaceGroup( new RunCommand(()-> drivetrain.curvatureDrive(-0.4,0)), new WaitCommand(2.5)),
        new ParallelRaceGroup( new RunCommand(()-> drivetrain.curvatureDrive(0,0)), new WaitCommand(0)),
