...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    this.m_robotContainer.turret.pitch.encoder.setPosition(0);
    ...
    /*trajectoree = TrajectoryGenerator.generateTrajectory(
      new Pose2d(0, 0, new Rotation2d(0)),
            ...
            // Pass config
        new TrajectoryConfig(Constants.Trajectory.kMaxSpeedMetersPerSecond, Constants.Trajectory.kMaxAccelerationMetersPerSecondSquared));
